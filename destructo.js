...
function revealPath({ direction, distance }) {
	console.log(`Travel ${distance} units toward the ${direction}`);
...
function castSpell([first, second]) {
	console.log(`Casting spell with ${first} and ${second}`);

}
castSpell(["Dragon Scale", "Phoenix Feather", "Unicorn Hair"])
...
const nestedSecert = {outer: { inner: "The Final Key" } };
